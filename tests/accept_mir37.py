...
mir = tirpan_get_mir('test_mir37.py')
...
n.false_literal = find_node_down_mir_nojoin(n.b_if.false,
...
n.true_literal = find_node_down_mir_nojoin(n.b_if.true,
...
n.a_true_literal = find_node_down_mir_nojoin(n.a_if.false,
                                            literal_value_checker(True))
n.a_true_assign = find_node_down_mir_nojoin(n.a_true_literal,
                                           assign_to_checker(n.r_assign.right))
assert n.a_true_assign.right == n.a_true_literal.left
find_node_down_mir_nojoin(n.a_true_assign, same_node_checker(n.join))

find_node_down_mir_nojoin(n.join, same_node_checker(n.r_assign))
find_node_down_mir_nojoin(n.r_assign, same_node_checker(None))


assert n.a_if.false is n.b_if.true