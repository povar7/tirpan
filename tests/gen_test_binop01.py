...
filename  = os.path.join(tests_dir, 'binop01.py')
testname  = os.path.join(tests_dir, 'test_binop01.py')
headname  = os.path.join(tests_dir, 'gen_test_binop01_head.txt')
corename  = os.path.join(tests_dir, 'gen_test_binop01_core.txt')
footname  = os.path.join(tests_dir, 'gen_test_binop01_foot.txt')
