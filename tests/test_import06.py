...
test_file_name_1 = get_test_file_name('import06_1.py')
test_file_name_2 = get_test_file_name('import06_2.py')
...
class TestTirpan(unittest.TestCase):
    ...
    def test_walk_var_x(self):
        node = findNode(self.nodes[0], line=4, col=1, kind=ast.Name)
