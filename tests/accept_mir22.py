...
mir = tirpan_get_mir('test_mir22.py')
...
find_node_down_mir_nojoin(n.u_if.true, same_node_checker(n.b_call))
...
find_node_down_mir_nojoin(n.v_if.false, same_node_checker(n.c_call))
n.w_if = find_node_down_mir_nojoin(n.w_call, if_cond_checker(n.w_call.left))
find_node_down_mir_nojoin(n.w_if.true, same_node_checker(n.b_call))
find_node_down_mir_nojoin(n.w_if.false, same_node_checker(n.c_call))
n.uvw_join = find_node_down_mir(n.b_call, isinstance_checker(ti.mir.JoinMirNode))
find_node_down_mir_nojoin(n.c_call, same_node_checker(n.uvw_join))


n.xyz_join = find_node_down_mir(n.a_call, isinstance_checker(ti.mir.JoinMirNode))
find_node_down_mir_nojoin(n.uvw_join, same_node_checker(n.xyz_join))
