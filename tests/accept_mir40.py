...
n = find_mir_nodes(mir,
                   ...
                   mklist = isinstance_checker(ti.mir.ListMirNode))


find_node_down_mir_nojoin(mir, same_node_checker(n.f_call))
find_node_down_mir_nojoin(n.f_call, same_node_checker(n.mklist))
assert n.mklist.elems[0] == n.f_call.left

find_node_down_mir_nojoin(mir, same_node_checker(n.g_call))
find_node_down_mir_nojoin(n.g_call, same_node_checker(n.mklist))
assert n.mklist.elems[1] == n.g_call.left

find_node_down_mir_nojoin(mir, same_node_checker(n.h_call))
find_node_down_mir_nojoin(n.h_call, same_node_checker(n.mklist))
assert n.mklist.elems[2] == n.h_call.left


n.subt0 = find_node_down_mir(n.mklist,
...
assert n.mklist.left == n.subt0.obj
find_node_down_mir(n.subt0, same_node_checker(n.a_assign))


n.subt1 = find_node_down_mir(n.mklist,
...
assert n.mklist.left == n.subt1.obj
find_node_down_mir(n.subt1, same_node_checker(n.b_assign))


n.subt2 = find_node_down_mir(n.mklist,
...
assert n.mklist.left == n.subt2.obj
