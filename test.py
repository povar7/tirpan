...
class TestMisc72(unittest.TestCase):
    
    ast, defects = tirpan.run('tests/misc72.py', orak_conf = noattr_conf)

    def test_defects(self):
        self.assertEqual(len(self.defects), 0,
                         'there must be no defects')

class TestMisc73(unittest.TestCase):
    
    ast, defects = tirpan.run('tests/misc73.py', orak_conf = noattr_conf)

    def test_defects(self):
        self.assertEqual(len(self.defects), 0,
                         'there must be no defects')

class TestMisc74(unittest.TestCase):
    
    ast, defects = tirpan.run('tests/misc74_1.py', orak_conf = noattr_conf)

    def test_defects(self):
        self.assertEqual(len(self.defects), 0,
                         'there must be no defects')

class TestMisc75(unittest.TestCase):
    
    ast, defects = tirpan.run('tests/misc75.py', orak_conf = noattr_conf)

    def test_defects(self):
        self.assertEqual(len(self.defects), 0,
                         'there must be no defects')

class TestMisc76(unittest.TestCase):
    
    ast, defects = tirpan.run('tests/misc76.py', orak_conf = noattr_conf)

    def test_defects(self):
        self.assertEqual(len(self.defects), 0,
                         'there must be no defects')

class TestMisc77(unittest.TestCase):
    
    ast, defects = tirpan.run('tests/misc77.py', orak_conf = noattr_conf)

    def test_defects(self):
        self.assertEqual(len(self.defects), 0,
                         'there must be no defects')

class TestMisc78(unittest.TestCase):
    
    ast, defects = tirpan.run('tests/misc78.py', orak_conf = noattr_conf)

    def test_defects(self):
        self.assertEqual(len(self.defects), 0,
                         'there must be no defects')

class TestMisc79(unittest.TestCase):
    
    ast, defects = tirpan.run('tests/misc79.py', orak_conf = noattr_conf)

    def test_defects(self):
        self.assertEqual(len(self.defects), 0,
                         'there must be no defects')

class TestMisc80(unittest.TestCase):
    
    ast, defects = tirpan.run('tests/misc80.py', orak_conf = noattr_conf)
